...
namespace use_Yok
{
	...
	template <class T>
	void Yok<T>::foundUni(University<T>* &uni ,string name)
	{ 
			uni = new University<int>[1];	/*i delete last university and define new adress for new university*/
			uni[0].set_Name_emp(name);		/*give name the new university*/
	}

	template <class T>
	void Yok<T>::giveJob(string name,string surname,University<T> * uni,Lecturer<T> * lec,ResearchAssistant<T> * res,Secretary<T> * sec,Officer<T> * off,int size_veriable,char who)
	{
		if (who == 'L')			/*for employ which job*/
		{
			cout << "YOK give job to " << name << " " << surname << " as Lecturer." << endl ;
		...
		{
			cout << "YOK give job to " << name << " " << surname << " as ResearchAssistant." << endl ;
		...
		{
			cout << "YOK give job to " << name << " " << surname << " as Officer." << endl ;
		...
		{
			cout << "YOK give job to " << name << " " << surname << " as Secretary." << endl ;		
