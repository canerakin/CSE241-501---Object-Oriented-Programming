...
namespace use_CommunistEducation
{

	template <class T>
	void CommunistEducation<T>::foundUni(University<T>* &uni ,string name)
	{ 
	...
	template <class T>
	void CommunistEducation<T>::giveJob(string name,string surname,University<T> * uni,Lecturer<T> * lec,ResearchAssistant<T> * res,Secretary<T> * sec,Officer<T> * off,int size_veriable,char who)
	{
		if (who == 'L')			/*for employ which job*/
		{
			cout << "CommunistEducation give job to " << name << " " << surname << " as Lecturer." << endl ;
		...
		{
			cout << "CommunistEducation give job to " << name << " " << surname << " as ResearchAssistant." << endl ;
		...
		{
			cout << "CommunistEducation give job to " << name << " " << surname << " as Officer." << endl ;
		...
		{
			cout << "CommunistEducation give job to " << name << " " << surname << " as Secretary." << endl ;		
